...
lv_obj_t * ui_Button1_create(lv_obj_t * comp_parent)
{
    ...
    lv_obj_set_height(cui_Button1, 100);
    lv_obj_set_x(cui_Button1, 59);
    lv_obj_set_y(cui_Button1, -117);
    ...
    lv_obj_set_style_bg_color(cui_Button1, lv_color_hex(0x1B1E29), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(cui_Button1, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_img_src(cui_Button1, &ui_img_670504427, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_color(cui_Button1, lv_color_hex(0x202029), LV_PART_MAIN | LV_STATE_DEFAULT);
